...
This is an toy Operating System for the Raspberry PI. 
It is based on [LumaOS](https://github.com/SheLovesLqwid/LumaOS-x86-Educational-Kernel-Project), my 32-bit OS.

## Usage

### Prerequisites

- Raspberry PI (or emulator)
